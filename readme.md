...
- Проект выполнен в рамках ограничения по времени (до 8 часов)
- Основной акцент сделан на корректную бизнес-логику и соответствие ТЗ
- Верстка минимальная и не является приоритетом
